    ...
    return (
        <div className="w-80 p-5 flex flex-col gap-5 bg-slate-50 h-full font-sans">
            <header className="flex items-center gap-3 border-b border-slate-200 pb-4">
                ...
                <div>
                    <h1 className="text-lg font-bold text-slate-800 leading-tight">GAS4U</h1>
                    <p className="text-xs text-slate-500 font-medium">AI coding assistant</p>
                </div>
            </header>
            ...
            <div className="flex flex-col gap-1.5">
                ...
                <p className="text-xs text-slate-400 mt-1">
                    Get your free API key from <a href="https://aistudio.google.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 font-medium hover:underline transition-colors">Google AI Studio</a>.
                </p>
            </div>
            ...
            {status && (
                <div className={`text-xs font-medium text-center p-2.5 rounded-lg flex items-center justify-center gap-2 animate-fade-in ${status.includes('Error') ? 'bg-red-50 text-red-600 border border-red-100' : 'bg-green-50 text-green-600 border border-green-100'}`}>
