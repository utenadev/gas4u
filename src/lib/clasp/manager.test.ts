...
describe("ClaspManager", () => {
  ...
  describe("loadProject", () => {
    ...
    it("should return first file if no SERVER_JS exists", async () => {
      const mockFiles: GASFile[] = [{ name: "Index", type: "HTML", source: "<html></html>" }];
      vi.mocked(GASClient.getContent).mockResolvedValue(mockFiles);
    ...
    it("should throw error when API call fails", async () => {
      ...
      await expect(ClaspManager.loadProject("test-script-id")).rejects.toThrow("API error");
    });
  });
  ...
  describe("saveProject", () => {
    it("should update existing file", async () => {
      ...
      await ClaspManager.saveProject("test-script-id", "function new() {}", "Code");
    ...
    it("should add new file if not found", async () => {
      ...
      await ClaspManager.saveProject("test-script-id", "function new() {}", "NewCode");
    ...
    it("should throw error when API call fails", async () => {
      ...
      await expect(
        ClaspManager.saveProject("test-script-id", "function test() {}", "Code")
