...
import { GenerateCodeResponse, ExplainCodeResponse, GeminiClientConfig } from './types';
...
export class GeminiClient {
    ...
    constructor(config: GeminiClientConfig) {
        ...
        this.model = this.genAI.getGenerativeModel({
            model: config.modelName || 'gemini-2.0-flash-exp' // Updated to latest avail or standard fallback
        });
    }
